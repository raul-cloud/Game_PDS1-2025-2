...
class Dungeon {
  ...
  public:
    ...
    std::vector<std::vector<int>>& GerarDungeon (Entidade& player); //ou na mao ou algoritmo estilo cellular automata
    ...
    bool SairDungeon (Entidade& player, std::vector<std::vector<int>>& grid);
    void Atualizar ();
    void ResetarDungeon (Entidade& player);
    ...
    bool CheckCollisionEnemy (Entidade& player);
